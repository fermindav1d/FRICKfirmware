...
{/*
  ...
  if (curPos>0)
  {
    switch(MenuEditMode)
    {
      case true: 
        ...
        setFreq(ui32CurrentOutputFreq,0); 
        setAmpdB(Amplitude.value * -1, 0);  //uncomment
  ...
  ///////////////////////////////////////////// NEW CODE ////////////////////////////////////
  uint32_t StartSweepFreq0 = 5125000UL; // initialize start frequency
  uint32_t StopSweepFreq0 = 5175000UL; // initalize stop frequency
 ...
 // dds.sweepRates(MyAD9959::Channel1,1,250,100,125);

    //channel 1
  dds.setFrequency(MyAD9959::Channel1, StartSweepFreq0);
  dds.sweepRates(MyAD9959::Channel1,1,255,1,1);
  

  // channel 2
  dds.setFrequency(MyAD9959::Channel2, StartSweepFreq0);
  dds.sweepRates(MyAD9959::Channel2,10,125,100,125);
  
  // channel 3
  dds.setFrequency(MyAD9959::Channel3, StartSweepFreq0);
  dds.sweepRates(MyAD9959::Channel3,10,125,100,125);
 ...
 // sweeping across all 4 channels
  ...
  digitalWrite(P2_PIN, LOW);
  digitalWrite(P3_PIN, LOW);
  delay(100); // can put a delay between sweeps
