...
{/*
  ...
  ///////////////////////////////////////////// NEW CODE ////////////////////////////////////
  uint32_t StartSweepFreq0 = 5000000UL; // initialize start frequency
  uint32_t StopSweepFreq0 = 5100000UL; // initalize stop frequency
  ...
  dds.sweepRates(MyAD9959::Channel1,10,125,100,125);
 ...
 // sweeping across all 4 channels
  ...
  //delay(10000); // can put a delay between sweeps
  digitalWrite(P0_PIN, LOW);
  digitalWrite(P1_PIN, LOW);
  digitalWrite(P2_PIN, LOW);
  digitalWrite(P3_PIN, LOW);
